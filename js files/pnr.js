...
loginpage.addEventListener('click',(e) => {
    ...
    const arr = ["C","h","e","c" ,"k"," ","P","N","R"," ","S","t","a","t","u","s"," ","!"]
...
let i = 0;
    ...
    function head(){
        if(i<18){
            ...
            ani.textContent = "Check PNR Status !";
...
let pnrnum = document.getElementById("pnr");
...
serbut.addEventListener('click', (e) => {
    ...
    if(pnrnum.value === ""){
        alert("Kindly enter the PNR Number correctly and completely.")
    }

    else{
        details.innerHTML = ` <div id="zap">
        <div id="patti">
            <h3>PNR Number </h3>
            <h3 id="PNRnum">22594244551</h3>
        </div>
        <div id="stat"><h3>Status</h3></div>
        <div id="ins">
            <div id="ulu">
                <h3>Passanger 1</h3>
                <div id="berth">B2,41</div>
            </div>
